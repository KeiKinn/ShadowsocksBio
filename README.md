...
* [新生代](#新生代)
    + [Surge—— 破局者](#surge破局者)
        - [题外话](#题外话)
    + [Shadowrocket—— 穿云箭](#shadowrocket穿云箭)
    + [Others](#others)
    + [Android](#android)
        - [Postern](#postern)
* [总结](#总结)
...
作者对高价的解释是 Surge 是面向国际的网络调试设备，主要竞品是老牌应用 Charles，但是这几年的发展下来，调试功能这种核心并没有实质的长进，反盗版能力，UI 设计倒是提升不少，口嫌体直般升级了 Shadowsocks 的最新版本，~~却死活不肯添加 V2ray 等新协议，~~面向国际的软件，核心用户却是国内用户，可以说是相当的傲娇。
